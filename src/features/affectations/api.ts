...
import type { AssignmentProgress, AssignmentTask, Center, CenterPayload, ListResponse, Region, RegionPayload, RegionalAssignment } from "./types"
...
export const affectationsApi = {
  ...
  async createRegionalAssignment(data: { immerge_id: number; region_id: number; motif?: string }) {
