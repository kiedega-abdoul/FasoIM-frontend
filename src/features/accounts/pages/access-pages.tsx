...
import { accessDomainLabel } from "../access-labels"
      ...
      <CardContent className="p-5 sm:p-6">
        <form onSubmit={submit} className="space-y-6">
          ...
          <section className="border-t pt-6">
            <div className="mb-5">
              <h2 className="text-xl font-semibold">Zone de travail</h2>
        ...
        <form onSubmit={submit} className="space-y-6">
          <section>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <Field label="Niveau de responsabilité *">
                <Input
                  type="number"
                  min="0"
                  className="h-12 rounded-xl px-4 text-base"
              ...
              {modules.map(([module,modulePermissions])=>
                <div key={module} className="rounded-2xl border bg-muted/20 p-4">
                  <div className="mb-3 flex items-center justify-between gap-3">
                    <h3 className="font-semibold">{accessDomainLabel(module)}</h3>
