...
export function NotFoundPage() {
  return (
    <section className="mx-auto flex min-h-[65vh] max-w-2xl flex-col items-center justify-center px-4 py-16 text-center">
      <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary">Erreur 404</p>
      <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">Page introuvable</h1>
      <p className="mt-4 text-muted-foreground">
        Cette adresse n’existe pas ou n’est plus disponible. Même les routes ont parfois besoin d’une affectation correcte.
      </p>
